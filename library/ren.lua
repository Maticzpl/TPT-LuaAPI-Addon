...
function renderer.hud(enabled) end
--```
...
---@param enabled boolean
function renderer.decorations(enabled) end
--```
...
---@param size number
function renderer.fireSize(size) end
--```
...
--  - `size`: floating point value that specifies the fire intensity.
---@return number
function renderer.fireSize() end
...
function renderer.useDisplayPreset(preset) end
