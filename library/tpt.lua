...
--If you don't pass in any arguments, it will return the current fps cap. If you set the fpscap to 2, this will uncap the framerate.<br>
---@param fpscap number
function tpt.fpsCap(fpscap) end
---@return number
