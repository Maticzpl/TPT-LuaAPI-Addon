...
---@return boolean
function Component:visible() end
...
---@return integer, integer
function Component:position() end
--#endregion
...
function Window:onKeyPress(listener) end

---@param listener KeyPressCallback
function Window:onKeyRelease(listener) end
...
function interface.showWindow(newWindow) end
...
---@param newWindow Window
function interface.closeWindow(newWindow) end
...
---@param newComponent Component
function interface.addComponent(newComponent) end
...
---@param component Component
function interface.removeComponent(component) end
...
---@param w integer
---@param h integer
function interface.textInputRect(x, y, w, h) end
...
function interface.beginInput(title, prompt, text, shadow, callback) end
-- Opens an input prompt, and runs a callback after the user's input.<br>
--  - `title`: Header message for the input prompt. Default "Title"<br>
--  - `prompt`: Body message for the input prompt, can be multiple lines. Default "Enter some text:"<br>
--  - `text`: Default text for the textbox. Defaults to empty string.<br>
...
---@param text string
---@param callback fun(userInput: string?)
function interface.beginInput(title, prompt, text, callback) end
-- Opens an input prompt, and runs a callback after the user's input.<br>
--  - `title`: Header message for the input prompt. Default "Title"<br>
--  - `prompt`: Body message for the input prompt, can be multiple lines. Default "Enter some text:"<br>
--  - `text`: Default text for the textbox. Defaults to empty string.<br>
...
---@param prompt string
---@param callback fun(userInput: string?)
function interface.beginInput(title, prompt, callback) end
-- Opens an input prompt, and runs a callback after the user's input.<br>
--  - `title`: Header message for the input prompt. Default "Title"<br>
--  - `prompt`: Body message for the input prompt, can be multiple lines. Default "Enter some text:"<br>
--  - `text`: Default text for the textbox. Defaults to empty string.<br>
...
---@param title string
---@param callback fun(userInput: string?)
function interface.beginInput(title, callback) end
-- Opens an input prompt, and runs a callback after the user's input.<br>
--  - `title`: Header message for the input prompt. Default "Title"<br>
--  - `prompt`: Body message for the input prompt, can be multiple lines. Default "Enter some text:"<br>
--  - `text`: Default text for the textbox. Defaults to empty string.<br>
...
-- Only the `callback` argument is required. The rest are optional. The final arg to the function will be used as the callback. If the user clicks "Okay" or presses enter, the textbox's text is passed. If the user clicks "Cancel", presses escape, or closes the dialog any other way, `nil` is passed.<br>
---@param callback fun(userInput: string?)
function interface.beginInput(callback) end
...
---@param large boolean
---@param callback fun()
function interface.beginMessageBox(title, message, large, callback) end
-- Opens a message box, and runs a callback after the user closes it.<br>
--  - `title`: Header message for the message box. Default "Title"<br>
--  - `message`: Body message for the message box, can be multiple lines. Default "Message"<br>
--  - `large`: boolean that controls if the message box should be a fixed-size larger variant, that is both taller and wider. Default false.<br>
...
---@param message string
---@param callback fun()
function interface.beginMessageBox(title, message, callback) end
-- Opens a message box, and runs a callback after the user closes it.<br>
--  - `title`: Header message for the message box. Default "Title"<br>
--  - `message`: Body message for the message box, can be multiple lines. Default "Message"<br>
--  - `large`: boolean that controls if the message box should be a fixed-size larger variant, that is both taller and wider. Default false.<br>
...
---@param title string
---@param callback fun()
function interface.beginMessageBox(title, callback) end
-- Opens a message box, and runs a callback after the user closes it.<br>
--  - `title`: Header message for the message box. Default "Title"<br>
--  - `message`: Body message for the message box, can be multiple lines. Default "Message"<br>
--  - `large`: boolean that controls if the message box should be a fixed-size larger variant, that is both taller and wider. Default false.<br>
...
--All arguments are optional. The final arg to the function will be used as the callback.<br>
---@param callback fun()
function interface.beginMessageBox(callback) end
...
---@param callback fun()
function interface.beginThrowError(errorMessage, callback) end
-- Opens an error dialog box, and runs a callback after the user closes it.<br>
--  - `errorMessage`: Body message for the error prompt, can be multiple lines. Default "Error Text"<br>
--  - `callback`: Callback function to run after the user closes the error prompt. Runs no matter how it is closed, and takes no arguments.<br>
--<br>
...
---@param type integer?
---@return (integer|nil)[]
function simulation.partNeighbors(x, y, radius, type) end
...
---@param type integer?
---@return (integer|nil)[]
function simulation.partNeighbours(x, y, radius, type) end
...
---@param index integer
---@param type integer
function simulation.partChangeType(index, type) end
...
---@return integer
function simulation.partCount() end
...
---@param type integer
---@return integer
function simulation.partCreate(index, x, y, type) end
...
---@param value any
function simulation.partProperty(index, field, value) end
--```
...
---@param field PartProperty
---@return any
function simulation.partProperty(index, field) end
...
---@param y integer
---@return integer
function simulation.partID(x, y) end
...
---@param index integer
function simulation.partKill(index) end
---@param x integer
---@param y integer
function simulation.partKill(x, y) end
...
---@param y integer
---@return number
function simulation.pressure(x, y) end
--```
...
function simulation.pressure(x, y, width, height, pressure) end
---@param x integer
---@param y integer
---@param pressure number
function simulation.pressure(x, y, pressure) end
...
---@param y integer
---@return number
function simulation.ambientHeat(x, y) end
--```
...
---@param height integer
---@param temp number
function simulation.ambientHeat(x, y, width, height, temp) end
---@param x integer
---@param y integer
---@param temp number
function simulation.ambientHeat(x, y, temp) end
...
---@param y integer
---@return number
function simulation.velocityX(x, y) end
--```
...
---@param height integer
---@param value number
function simulation.velocityX(x, y, width, height, value) end
---@param x integer
---@param y integer
---@param value number
function simulation.velocityX(x, y, value) end
...
---@param y integer
---@return number
function simulation.velocityY(x, y) end
--```
...
---@param height integer
---@param value number
function simulation.velocityY(x, y, width, height, value) end
---@param x integer
---@param y integer
---@param value number
function simulation.velocityY(x, y, value) end
...
---@param y integer
---@return number
function simulation.gravMap(x, y) end
--### **DEPRECATED IN 98.0, replaced by sim.gravityMass and sim.gravityField**<br>
--Returns the newtonian gravity at the given coordinates in the simulation. If given a value, will set the newtonian gravity at those coordinates. Width and height refer to the rectangle of affected cells, starting with the coords. If not given, they will default to 1,1.<br>
---@deprecated
---@param x integer
...
---@param height integer
---@param value number
function simulation.gravMap(x, y, width, height, value) end
--### **DEPRECATED IN 98.0, replaced by sim.gravityMass and sim.gravityField**<br>
--Returns the newtonian gravity at the given coordinates in the simulation. If given a value, will set the newtonian gravity at those coordinates. Width and height refer to the rectangle of affected cells, starting with the coords. If not given, they will default to 1,1.<br>
---@deprecated
---@param x integer
---@param y integer
---@param value number
function simulation.gravMap(x, y, value) end
...
---@param y integer
---@return number
function simulation.gravityMass(x, y) end
--```
...
---@param y integer
---@param strength number
function simulation.gravityMass(x, y, strength) end
--```
...
---@param h integer
---@param strength number
function simulation.gravityMass(x, y, w, h, strength) end
...
---@return boolean
function simulation.newtonianGravity() end
--```
--sim.newtonianGravity(enabled)
--```
--  - `newtonianGravity`: boolean flag that specifies whether Newtonian Gravity is turned on or off.
---@param enabled boolean
function simulation.newtonianGravity(enabled) end
...
function simulation.resetSpark() end
...
function simulation.resetGravityField() end
...
function simulation.resetVelocity() end
...
---@param flag integer?
---@return number
function simulation.createParts(x, y, rx, ry, type, brush, flag) end
...
---@param type integer?
---@param flag integer?
function simulation.createBox(x1, y1, x2, y2, type, flag) end
...
---@param flag integer?
---@return integer
function simulation.floodParts(x, y, type, cm, flag) end
...
---@return number
function simulation.createWalls(x, y, rx, ry, walltype) end
...
---@param ry integer?
---@param walltype WallType?
function simulation.createWallLine(x1, y1, x2, y2, rx, ry, walltype) end
...
---@param y2 integer
---@param walltype WallType?
function simulation.createWallBox(x1, y1, x2, y2, walltype) end
...
---@param bm integer?
---@return number
function simulation.floodWalls(x, y, walltype, bm) end
...
---@param y integer
---@return WallType
function simulation.wallMap(x, y) end
--```
...
---@param y integer
---@param wallType WallType
function simulation.wallMap(x, y, wallType) end
--```
...
---@param h integer
---@param wallType WallType
function simulation.wallMap(x, y, w, h, wallType) end
...
---@param strength number?
---@return number
function simulation.toolBrush(x, y, rx, ry, tool, brush, strength) end
...
---@param brush integer?
---@param strength number?
function simulation.toolLine(x1, y1, x2, y2, rx, ry, tool, brush, strength) end
...
---@param tool integer?
---@param strength number?
function simulation.toolBox(x1, y1, x2, y2, tool, strength) end
...
---@param tool integer?
---@param brush integer?
function simulation.decoBrush(x, y, rx, ry, r, g, b, a, tool, brush) end
...
---@param tool integer?
---@param brush integer?
function simulation.decoLine(x1, y1, x2, y2, rx, ry, r, g, b, a, tool, brush) end
...
---@param a integer?
---@param tool integer?
function simulation.decoBox(x1, y1, x2, y2, r, g, b, a, tool) end
...
---@return integer
function simulation.decoColor() end
--```
...
---@param color integer
function simulation.decoColor(color) end
--```
...
---@param b integer
---@param a integer?
function simulation.decoColor(r, g, b, a) end
...
--Returns the currently selected decoration color.<br>
---@return integer
function simulation.decoColour() end
--```
...
function simulation.decoColour(colour) end
--```
...
---@param b integer
---@param a integer?
function simulation.decoColour(r, g, b, a) end
...
function simulation.decoSpace(colorSpace) end
--```
...
function simulation.decoSpace() end
...
---@return string
function simulation.saveStamp(x, y, width, height, includePressure) end
---@return string
function simulation.saveStamp() end
...
function simulation.loadStamp(filename, x, y) end
---@param id integer
---@param x integer
---@param y integer
---@return number | nil, string | nil
function simulation.loadStamp(id, x, y) end
...
---@return string[]
function simulation.listStamps() end
...
---@param name string
function simulation.deleteStamp(name) end
---@param id integer
function simulation.deleteStamp(id) end
...
function simulation.loadSave(SaveID, hideDescription, history) end
...
---@return integer, integer
function simulation.getSaveID() end
...
---@param y integer
---@return integer, integer
function simulation.adjustCoords(x, y) end
...
---@return integer
function simulation.prettyPowders() end
---@param mode integer
...
---@return integer
function simulation.edgeMode() end
--```
...
---@param mode integer
function simulation.edgeMode(mode) end
...
---@return GravityMode
function simulation.gravityMode() end
--```
...
function simulation.gravityMode(mode) end
...
---@param x number?
---@param y number
function simulation.customGravity(x, y) end
--```
...
---@return number, number
function simulation.customGravity() end
...
---@return AirMode
function simulation.airMode() end
--```
...
-- - 4 No update<br>
---@param mode AirMode
function simulation.airMode(mode) end
...
---@return integer
function simulation.waterEqualization() end
--```
--nil sim.waterEqualization(number setting)
--```
--Set the Water equalization setting to setting.<br>
---@param setting integer
function simulation.waterEqualization(setting) end
...
---@param enabled boolean
function simulation.ambientHeatSim(enabled) end
--```
--enabled = sim.ambientHeatSim()
--```
-- - `enabled`: Flag that specifies whether ambient heat is enabled or not.<br>
---@return boolean
function simulation.ambientHeatSim() end
...
---@return boolean
function simulation.heatSim() end
--```
--sim.heatSim(enabled)
--```
--  - `heatSim`: boolean flag that specifies whether heat simulation is turned on or off.
---@param enabled boolean
function simulation.heatSim(enabled) end
...
---@param type integer
---@return integer
function simulation.elementCount(type) end
...
function simulation.can_move(movingElementID, obstacleElementID) end
...
---@param y integer
---@return integer
function simulation.pmap(x, y) end
...
---@param y integer
---@return integer
function simulation.photons(x, y) end
...
---@param y integer
---@return integer
function simulation.elecMap(x, y) end
--```
...
---@param y integer
---@param value integer
function simulation.elecMap(x, y, value) end
--```
...
---@param h integer
---@param value integer
function simulation.elecMap(x, y, w, h, value) end
...
function simulation.neighbors(x, y, rx, ry, type) end
---@param x integer
---@param y integer
---@return fun(): number, number, number
function simulation.neighbors(x, y) end
...
function simulation.framerender(frames) end
---@return integer
function simulation.framerender() end
...
---@return integer
function simulation.gspeed() end
--```
...
function simulation.gspeed(newSpeed) end
...
---@return integer
function simulation.replaceModeFlags() end
--```
...
function simulation.signs.delete(signID) end
...
---@return integer|nil
function simulation.signs.new(text, x, y, justification) end
...
---@param y integer
---@return number
function simulation.fanVelocityX(x, y) end
--```
...
---@param y integer
---@param value number
function simulation.fanVelocityX(x, y, value) end
--```
...
---@param h integer
---@param value number
function simulation.fanVelocityX(x, y, w, h, value) end
...
---@param y integer
---@return number
function simulation.fanVelocityY(x, y) end
--```
...
---@param y integer
---@param value number
function simulation.fanVelocityY(x, y, value) end
--```
...
---@param h integer
---@param value number
function simulation.fanVelocityY(x, y, w, h, value) end
...
---@return boolean
function simulation.paused() end
--```
--sim.paused(flag)
--```
--  - `flag`: Boolean flag that says whether or not the sim is paused.<br>
...
---@param flag boolean
function simulation.paused(flag) end
...
function renderer.renderModes(newModes) end
---@return integer[]
function renderer.renderModes() end
...
--```
---@param newModes integer[]
function renderer.displayModes(newModes) end
---@return integer[]
function renderer.displayModes() end
...
---@return integer
function renderer.colorMode() end
---@param colorMode integer
function renderer.colorMode(colorMode) end
--```
...
function renderer.decorations(decoSetting) end
---@return integer
function renderer.decorations() end
...
function renderer.grid(gridSize) end
---@return integer
function renderer.grid() end
...
function renderer.showBrush(brushSetting) end
---@return integer
function renderer.showBrush() end
...
function renderer.zoomEnabled(zoomState) end
---@return boolean
function renderer.zoomEnabled() end
...
function renderer.zoomWindow(x, y, zoomFactor) end
---@return integer x, integer y, integer zoomFactor, number windowSize
function renderer.zoomWindow() end
...
function renderer.zoomScope() end
---@param x integer
---@param y integer
---@param size integer
function renderer.zoomScope(x, y, size) end
--#endregion
...
---@param text string
---@return integer, integer
function graphics.textSize(text) end
...
---@param b integer
---@param a integer?
function graphics.drawText(x, y, text, r, g, b, a) end
---@param x number
---@param y number
---@param text string
function graphics.drawText(x, y, text) end
...
---@param b integer
---@param a integer?
function graphics.drawLine(x1, y1, x2, y2, r, g, b, a) end
---@param x1 integer
---@param y1 integer
---@param x2 integer
---@param y2 integer
function graphics.drawLine(x1, y1, x2, y2) end
...
---@param b integer
---@param a integer?
function graphics.drawRect(x, y, width, height, r, g, b, a) end
---@param x integer
---@param y integer
---@param width integer
---@param height integer
function graphics.drawRect(x, y, width, height) end
...
---@param b integer
---@param a integer?
function graphics.fillRect(x, y, width, height, r, g, b, a) end
---@param x number
---@param y number
---@param width number
---@param height number
function graphics.fillRect(x, y, width, height) end
...
---@param b integer
---@param a integer?
function graphics.drawCircle(x, y, radiusW, radiusH, r, g, b, a) end
---@param x integer
---@param y integer
---@param radiusW integer
---@param radiusH integer
function graphics.drawCircle(x, y, radiusW, radiusH) end
...
---@param b integer
---@param a integer?
function graphics.fillCircle(x, y, radiusW, radiusH, r, g, b, a) end
---@param x integer
---@param y integer
---@param radiusW integer
---@param radiusH integer
function graphics.fillCircle(x, y, radiusW, radiusH) end
...
---@param x integer
---@param y integer
function graphics.drawPixel(x, y) end
--```
--graphics.drawPixel(number x, number y, [number r, number g, number b, [number a]])
--```
-- Draws a pixel at (x, y). Providing the color is optional, if not provided defaults to white.
...
---@param b integer
---@param a integer?
function graphics.drawPixel(x, y, r, g, b, a) end
...
function graphics.getColors(color) end
...
---@param a integer?
---@return integer
function graphics.getHexColor(r, g, b, a) end
...
function graphics.setClipRect(x, y, w, h) end
...
---@param folder string
---@return string[]
function fileSystem.list(folder) end
...
---@param path string
---@return boolean
function fileSystem.removeDirectory(path) end
...
---@param path string
---@return boolean
function fileSystem.removeFile(path) end
...
---@return boolean
function fileSystem.move(path, newPath) end
...
---@param newPath string
---@return boolean
function fileSystem.copy(path, newPath) end
--#endregion
...
---@return integer
function event.getmodifiers() end
--#endregion
...
function HTTPRequest:progress() end
...
function HTTPRequest:finish() end
...
---@param verb string?
---@return HTTPRequest
function http.get(uri, headers, verb) end
...
---@param verb string?
---@return HTTPRequest
function http.post(uri, postParams, headers, verb) end
