...
function interface.button:action(callback) end
...
function interface.slider:onValueChanged(callback) end
...
function interface.checkbox:action(callback) end
...
function interface.textbox:onTextChanged(callback) end
